...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Back-office for managing gift card trades, cards, countries, denominations and exchange rates." },
      { name: "author", content: "Plut" },
      { property: "og:title", content: "Plut Admin — Super Admin Dashboard" },
      { property: "og:description", content: "Back-office for managing gift card trades, cards, countries, denominations and exchange rates." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Plut Admin — Super Admin Dashboard" },
      { name: "twitter:description", content: "Back-office for managing gift card trades, cards, countries, denominations and exchange rates." },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('plut-theme');if(t==='dark'){document.documentElement.classList.add('dark');}else{document.documentElement.classList.remove('dark');}}catch(e){}})();`,
          }}
        />
      </head>
      <body>
