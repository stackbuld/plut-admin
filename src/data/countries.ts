...
export const WORLD_COUNTRIES: CountryOption[] = [
  ...
  { name: "Cabo Verde", code: "CV", currencyCode: "CVE" },
  ...
  { name: "Congo (Brazzaville)", code: "CG", currencyCode: "XAF" },
  ...
  { name: "Eswatini", code: "SZ", currencyCode: "SZL" },
  ...
  { name: "Micronesia", code: "FM", currencyCode: "USD" },
  ...
  { name: "South Sudan", code: "SS", currencyCode: "SSP" },
  ...
  { name: "Vatican City", code: "VA", currencyCode: "EUR" },
